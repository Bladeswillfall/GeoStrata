...
- **Petroleum-stained reservoir hosts:** inherit the underlying host block's hardness, blast resistance, piston behaviour, flammability, tool and harvest tier. **Normal mining drops the ordinary unstained host block; Silk Touch preserves the petroleum-stained variant. Fortune has no special petroleum effect.** Once a stained variant has been Silk-Touched and placed, it remains stained indefinitely; there is no weathering, drying, decay, or automatic reversion mechanic.
...
Avoid inventing extra waterproofing, dye or processing systems until a concrete gameplay need justifies them. Natural placed bitumen should not become a propagating fire hazard.
