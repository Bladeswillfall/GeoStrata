...
- **Petroleum-stained reservoir hosts:** inherit the underlying host block's hardness, blast resistance, piston behaviour, flammability, tool and harvest tier. **Normal mining drops the ordinary unstained host block; Silk Touch preserves the petroleum-stained variant. Fortune has no special petroleum effect.** This keeps staining as geological evidence while still allowing builders/collectors to preserve it deliberately.
