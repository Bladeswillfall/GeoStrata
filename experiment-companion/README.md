...
Normal GeoStrata installs remain unchanged. The companion suppresses vanilla Overworld placed features only for resources the active experiment replaces: coal, iron, copper, gold, emerald and diamond. Unsupported vanilla resources such as redstone and lapis remain generated by Minecraft. This keeps validation worlds free of duplicate generation for the systems under test without deleting resources GeoStrata does not yet own.
