...
- Ships versioned JSON tables for:
  ...
  - Overwrite guardrails and replacement-priority contracts (including constrained sculk behavior).
  - Generated ore-block family contract, drop mapping rules, and worldgen suppression planning tables.
...
- Overwrite guardrails provide data contracts for preserving grade-critical host rock while allowing constrained surface-level replacement behavior.
